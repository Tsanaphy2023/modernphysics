...
def get_simulator_html_and_js(page_id, sim_type, title, standalone=False):
    ...
    if sim_type == "classical_limits":
        ...
        <div class="sim-panel" id="{prefix}_panel">
          ...
          <div class="sim-canvas-wrapper"><canvas id="{prefix}_canvas" width="640" height="230" style="background:#020617; width:100%; max-width:640px; display:block; margin:0 auto; border-radius:8px;"></canvas></div>
        ...
        (function() {{
          ...
          function run() {{ if (!initSim()) setTimeout(run, 80); }}
    ...
    # -------------------------------------------------------------
    # 1.2 Planck Blackbody (Wien peak & Stefan-Boltzmann)
    # -------------------------------------------------------------
        ...
        (function() {{
          function initSim() {{
            ...
            function draw() {{
              ...
              let col = "แดง";
              if (T > 3500 && 5000 >= T) col = "ส้ม-เหลือง";
              else if (T > 5000 && 7500 >= T) col = "ขาวนวล (Yellow-White)";
              else if (T > 7500 && 10000 >= T) col = "ขาวอมฟ้า (Blue-White)";
    ...
    # -------------------------------------------------------------
    # 1.3 Photoelectric Effect (Work Function & Stopping Potential)
    # -------------------------------------------------------------
        ...
        <div class="sim-panel" id="{prefix}_panel">
          ...
          <div class="sim-canvas-wrapper"><canvas id="{prefix}_canvas" width="640" height="200" style="background:#020617; width:100%; max-width:640px; display:block; margin:0 auto; border-radius:8px;"></canvas></div>
          <div class="sim-readout-grid">
        ...
        (function() {{
          function initSim() {{
            ...
            let particles = [];
            for(let i=0; 20 > i; i++) particles.push({{ x: 120 + Math.random()*20, y: 40 + Math.random()*120, vx: 2 + Math.random()*3 }});
            ...
            function render() {{
              ...
              // Incoming Photons
              ctx.strokeStyle = 400 > lam ? "#a855f7" : (550 > lam ? "#00f0ff" : "#ef4444");
              ctx.lineWidth = 2.5;
              for(let i=0; 3 > i; i++) {{
                ctx.beginPath();
    ...
    # -------------------------------------------------------------
        ...
        <div class="sim-panel" id="{prefix}_panel">
          ...
          <div class="sim-canvas-wrapper"><canvas id="{prefix}_canvas" width="640" height="210" style="background:#020617; width:100%; max-width:640px; display:block; margin:0 auto; border-radius:8px;"></canvas></div>
          <div class="sim-readout-grid">
        ...
        (function() {{
          function initSim() {{
            ...
            function draw() {{
              const n1 = +sel.value;
              slider.min = n1 + 1;
              if (n1 >= +slider.value) slider.value = n1 + 1;
    ...
    # -------------------------------------------------------------
    # 2.1 Light Clock (Special Relativity Postulate)
    # -------------------------------------------------------------
        ...
        <div class="sim-panel" id="{prefix}_panel">
          ...
          <div class="sim-canvas-wrapper"><canvas id="{prefix}_canvas" width="640" height="220" style="background:#020617; width:100%; max-width:640px; display:block; margin:0 auto; border-radius:8px;"></canvas></div>
          <div class="sim-readout-grid">
    ...
    # -------------------------------------------------------------
    # 2.4 Mass-Energy Equivalence E = mc²
    # -------------------------------------------------------------
        ...
        (function() {{
          function initSim() {{
            ...
            function draw() {{
              ...
              for(let x=40; 600 > x; x+=40) {{
                for(let y=30; 190 > y; y+=30) {{
    ...
    # -------------------------------------------------------------
    # General Dynamic Physics Wave/Field Simulator for all other topics
    # -------------------------------------------------------------
    else:
        return f"""
        <div class="sim-panel" id="{prefix}_panel">
