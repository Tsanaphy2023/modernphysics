...
def get_chapter_4():
    ...
    <p>กระแสทะลุผ่าน (Tunneling Current: $I_t$) มีความไวต่อระยะห่าง $d$ ในระดับเอกซ์โพเนนเชียลอย่างยิ่งยวด โดยการเปลี่ยนระยะห่างเพียง $0.1	ext{ nm}$ (ประมาณ 1 อังสตรอม) จะทำให้กระแสเปลี่ยนไปถึง 10 เท่า ($1000\%$) ส่งผลให้ STM มีความละเอียดในแนวดิ่งสูงถึง $0.01	ext{ nm}$ ($0.1	ext{ \AA}$) ซึ่งละเอียดกว่าขนาดของอะตอมเดี่ยว</p>
      ...
      <div class="figure-card">
        <img src="../assets/images/stm_atomic_metrology_3d.jpg" alt="ภาพเสมือนจริง 3 มิติ: การควบคุมจัดเรียงอะตอมเดี่ยวและการวัดกระแสทะลุผ่านเชิงควอนตัมระดับซับแองสตรอมด้วยกล้องจุลทรรศน์ STM">
        <div class="caption"><strong>ภาพที่ 4.1.1</strong>: ภาพเสมือนจริง 3 มิติ: การควบคุมจัดเรียงอะตอมเดี่ยวและการวัดกระแสทะลุผ่านเชิงควอนตัมระดับซับแองสตรอมด้วยกล้องจุลทรรศน์ STM</div>
      </div>
