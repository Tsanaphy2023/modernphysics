...
def get_chapter_8():
    ...
    <p>การผสานเซลล์เพอรอฟสไกต์ที่มีช่องว่างแถบพลังงานกว้าง ($E_{g1} pprox 1.68	ext{ eV}$) เข้ากับเซลล์ซิลิคอนช่องว่างแคบ ($E_{g2} pprox 1.12	ext{ eV}$) ช่วยก้าวข้ามขีดจำกัดช็อกคลีย์-ไควเซอร์สำหรับรอยต่อเดี่ยว (Shockley-Queisser Limit: 33.7%) มุ่งสู่อนาคตพลังงานสะอาดที่มีต้นทุนต่ำและประสิทธิภาพสูงสุด</p>
      ...
      <div class="figure-card">
        <img src="../assets/images/perovskite_tandem_solar_3d.jpg" alt="ภาพเสมือนจริง 3 มิติ: เซลล์แสงอาทิตย์เพอรอฟสไกต์แทนเดมร่วมกับเซลล์ซิลิคอนและระบบเร่งปฏิกิริยาแยกน้ำด้วยแสงอาทิตย์แบบซีสกีม">
        <div class="caption"><strong>ภาพที่ 8.1.1</strong>: ภาพเสมือนจริง 3 มิติ: เซลล์แสงอาทิตย์เพอรอฟสไกต์แทนเดมร่วมกับเซลล์ซิลิคอนและระบบเร่งปฏิกิริยาแยกน้ำด้วยแสงอาทิตย์แบบซีสกีม</div>
      </div>
