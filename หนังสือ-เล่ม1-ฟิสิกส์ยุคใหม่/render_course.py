...
<div class="moodle-page-wrapper">
  ...
  <div class="content">
    ...
    <div class="interactive-sim-container" style="background:#090e1a; border:1px solid #1e293b; border-radius:14px; padding:18px; margin:24px 0; box-shadow:0 8px 30px rgba(0,0,0,0.5);">
      ...
      <iframe src="https://tsanaphy2023.github.io/modernphysics/simulators/sim_{page['id'].replace('.', '_')}.html?v=2026" style="width:100%; height:520px; border:1px solid #1e293b; border-radius:10px; background:#020617;" allow="accelerometer; autoplay; camera; gyroscope;"></iframe>
    </div>
...
def build_subtopic_page_html(ch, page, all_pages, current_idx):
    ...
    <div class="simulator-container" id="sim-box-{page["id"]}" style="margin:24px 0;">
      ...
      <div class="sim-body" id="sim-body-{page["id"]}">
        <iframe src="simulators/sim_{page['id'].replace('.', '_')}.html?v=2026" style="width:100%; height:520px; border:1px solid #1e293b; border-radius:10px; background:#020617;" allow="accelerometer; autoplay; camera; gyroscope;"></iframe>
      </div>
    </div>
    """
